function upload_document(type)
{
	...
	if (type == "Delete")
	{
		...
		deleteFunction('adminservices_incoming_records/upload_document', params, 'outgoingRecordsListGrid', null);
	}
	else
	{
		addeditFunction('adminservices_incoming_records/upload_document', params, 'outgoingRecordsListGrid', null, uploadForm, uploadWindow);
	}
						...
						fn: function(btn){
							if (btn == 'yes')
							{
								uploadForm.submit({
			                        ...
			                        method: "POST",	
			                        params: {record_id: incomingRecordID, type: type, com_type: 'Outgoing'},
			                        timeout: 1800000,
